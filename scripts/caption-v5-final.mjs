...
const segments = [
  ...
  ["02-01-zeke-bed-phone.mp4", "02-zeke-bed-phone.txt", 4, "top", "uniform"],
  ["03-02-james-kitchen-laptops.mp4", "03-james-kitchen-laptops.txt", 5, "bottom", "whisper"],
  ...
  ["09-09-james-fund.mp4", "09-james-fund.txt", 6, "bottom", "whisper"],
  ...
  ["12-12-zeke-finale.mp4", "12-zeke-finale.txt", 6, "bottom", "uniform"],
];
...
for (const [video, transcript, words, position, timingMode] of segments) {
  const args = [
    "run", "caption",
    join(inputDir, video),
